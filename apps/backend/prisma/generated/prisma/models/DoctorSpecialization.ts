...
export type DoctorSpecializationWhereInput = {
  ...
  id_doctor?: Prisma.IntFilter<"DoctorSpecialization"> | number
  id_spec?: Prisma.IntFilter<"DoctorSpecialization"> | number
  assigned_date?: Prisma.DateTimeNullableFilter<"DoctorSpecialization"> | Date | string | null
...
export type DoctorSpecializationOrderByWithRelationInput = {
  ...
  assigned_date?: Prisma.SortOrderInput | Prisma.SortOrder
...
export type DoctorSpecializationWhereUniqueInput = Prisma.AtLeast<{
  id_doctor_id_spec?: Prisma.DoctorSpecializationId_doctorId_specCompoundUniqueInput
  AND?: Prisma.DoctorSpecializationWhereInput | Prisma.DoctorSpecializationWhereInput[]
  OR?: Prisma.DoctorSpecializationWhereInput[]
  NOT?: Prisma.DoctorSpecializationWhereInput | Prisma.DoctorSpecializationWhereInput[]
  id_doctor?: Prisma.IntFilter<"DoctorSpecialization"> | number
...
export type DoctorSpecializationScalarWhereWithAggregatesInput = {
  ...
  id_doctor?: Prisma.IntWithAggregatesFilter<"DoctorSpecialization"> | number
  id_spec?: Prisma.IntWithAggregatesFilter<"DoctorSpecialization"> | number
  assigned_date?: Prisma.DateTimeNullableWithAggregatesFilter<"DoctorSpecialization"> | Date | string | null
}

export type DoctorSpecializationCreateInput = {
  assigned_date?: Date | string | null
  Doctor: Prisma.DoctorCreateNestedOneWithoutDoctorSpecializationInput
  Specialization: Prisma.SpecializationCreateNestedOneWithoutDoctorSpecializationInput
}
...
export type DoctorSpecializationUpdateInput = {
  assigned_date?: Prisma.NullableDateTimeFieldUpdateOperationsInput | Date | string | null
  Doctor?: Prisma.DoctorUpdateOneRequiredWithoutDoctorSpecializationNestedInput
  Specialization?: Prisma.SpecializationUpdateOneRequiredWithoutDoctorSpecializationNestedInput
}
...
export type DoctorSpecializationId_doctorId_specCompoundUniqueInput = {
  id_doctor: number
  id_spec: number
}
...
export type DoctorSpecializationOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id_doctor" | "id_spec" | "assigned_date", ExtArgs["result"]["doctorSpecialization"]>
...
export interface DoctorSpecializationDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const doctorSpecializationWithId_doctorOnly = await prisma.doctorSpecialization.findMany({ select: { id_doctor: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many DoctorSpecializations and only return the `id_doctor`
   * const doctorSpecializationWithId_doctorOnly = await prisma.doctorSpecialization.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more DoctorSpecializations and only return the `id_doctor`
   * const doctorSpecializationWithId_doctorOnly = await prisma.doctorSpecialization.updateManyAndReturn({
   *   select: { id_doctor: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface DoctorSpecializationFieldRefs {
  readonly id_doctor: Prisma.FieldRef<"DoctorSpecialization", 'Int'>
  readonly id_spec: Prisma.FieldRef<"DoctorSpecialization", 'Int'>
  readonly assigned_date: Prisma.FieldRef<"DoctorSpecialization", 'DateTime'>
}
