...
export type MedicationWhereInput = {
  ...
  id_medication?: Prisma.IntFilter<"Medication"> | number
  name?: Prisma.StringFilter<"Medication"> | string
  active_substance?: Prisma.StringNullableFilter<"Medication"> | string | null
...
export type MedicationOrderByWithRelationInput = {
  ...
  active_substance?: Prisma.SortOrderInput | Prisma.SortOrder
...
export type MedicationScalarWhereWithAggregatesInput = {
  ...
  id_medication?: Prisma.IntWithAggregatesFilter<"Medication"> | number
  name?: Prisma.StringWithAggregatesFilter<"Medication"> | string
  active_substance?: Prisma.StringNullableWithAggregatesFilter<"Medication"> | string | null
...
export type MedicationCreateInput = {
  ...
  form?: string | null
  dosage?: string | null
  Prescription?: Prisma.PrescriptionCreateNestedManyWithoutMedicationInput
}
...
export type MedicationUncheckedCreateInput = {
  ...
  form?: string | null
  dosage?: string | null
  Prescription?: Prisma.PrescriptionUncheckedCreateNestedManyWithoutMedicationInput
}

export type MedicationUpdateInput = {
  name?: Prisma.StringFieldUpdateOperationsInput | string
  active_substance?: Prisma.NullableStringFieldUpdateOperationsInput | string | null
  ...
  Prescription?: Prisma.PrescriptionUpdateManyWithoutMedicationNestedInput
}

export type MedicationUncheckedUpdateInput = {
  id_medication?: Prisma.IntFieldUpdateOperationsInput | number
  name?: Prisma.StringFieldUpdateOperationsInput | string
  active_substance?: Prisma.NullableStringFieldUpdateOperationsInput | string | null
  form?: Prisma.NullableStringFieldUpdateOperationsInput | string | null
  dosage?: Prisma.NullableStringFieldUpdateOperationsInput | string | null
  Prescription?: Prisma.PrescriptionUncheckedUpdateManyWithoutMedicationNestedInput
}
...
export type MedicationCountOrderByAggregateInput = {
  id_medication?: Prisma.SortOrder
  name?: Prisma.SortOrder
  active_substance?: Prisma.SortOrder
...
export type MedicationCreateNestedOneWithoutPrescriptionInput = {
  ...
  connectOrCreate?: Prisma.MedicationCreateOrConnectWithoutPrescriptionInput
  connect?: Prisma.MedicationWhereUniqueInput
}

export type MedicationUpdateOneWithoutPrescriptionNestedInput = {
  create?: Prisma.XOR<Prisma.MedicationCreateWithoutPrescriptionInput, Prisma.MedicationUncheckedCreateWithoutPrescriptionInput>
  connectOrCreate?: Prisma.MedicationCreateOrConnectWithoutPrescriptionInput
  upsert?: Prisma.MedicationUpsertWithoutPrescriptionInput
  disconnect?: Prisma.MedicationWhereInput | boolean
  delete?: Prisma.MedicationWhereInput | boolean
  connect?: Prisma.MedicationWhereUniqueInput
  update?: Prisma.XOR<Prisma.XOR<Prisma.MedicationUpdateToOneWithWhereWithoutPrescriptionInput, Prisma.MedicationUpdateWithoutPrescriptionInput>, Prisma.MedicationUncheckedUpdateWithoutPrescriptionInput>
}
...
export type MedicationUpsertWithoutPrescriptionInput = {
...
export type MedicationUpdateToOneWithWhereWithoutPrescriptionInput = {
  where?: Prisma.MedicationWhereInput
...
export type MedicationCountOutputTypeSelect<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  Prescription?: boolean | MedicationCountOutputTypeCountPrescriptionArgs
}
 ...
 * MedicationCountOutputType without action
 */
export type MedicationCountOutputTypeCountPrescriptionArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
...
export type MedicationSelect<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetSelect<{
  ...
  name?: boolean
  active_substance?: boolean
  form?: boolean
  dosage?: boolean
  Prescription?: boolean | Prisma.Medication$PrescriptionArgs<ExtArgs>
...
export type MedicationOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id_medication" | "name" | "active_substance" | "form" | "dosage", ExtArgs["result"]["medication"]>
...
export interface MedicationDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `id_medication`
   * const medicationWithId_medicationOnly = await prisma.medication.findMany({ select: { id_medication: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Medications and only return the `id_medication`
   * const medicationWithId_medicationOnly = await prisma.medication.createManyAndReturn({
   *   select: { id_medication: true },
   *   data: [
   *     // ... provide data here
   *   ]
   * })
   ...
   * })
   * 
   * // Update zero or more Medications and only return the `id_medication`
   * const medicationWithId_medicationOnly = await prisma.medication.updateManyAndReturn({
   *   select: { id_medication: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface Prisma__MedicationClient<T, Null = never, ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> extends Prisma.PrismaPromise<T> {
  ...
  Prescription<T extends Prisma.Medication$PrescriptionArgs<ExtArgs> = {}>(args?: Prisma.Subset<T, Prisma.Medication$PrescriptionArgs<ExtArgs>>): Prisma.PrismaPromise<runtime.Types.Result.GetResult<Prisma.$PrescriptionPayload<ExtArgs>, T, "findMany", GlobalOmitOptions> | Null>
  /**
...
export interface MedicationFieldRefs {
  readonly id_medication: Prisma.FieldRef<"Medication", 'Int'>
  readonly name: Prisma.FieldRef<"Medication", 'String'>
  readonly active_substance: Prisma.FieldRef<"Medication", 'String'>
 ...
 */
export type Medication$PrescriptionArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
